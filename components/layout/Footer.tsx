    ...
    <footer className="bg-[#09090B] text-white">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-16 lg:grid-cols-4">
          ...
          <div>
            <h3 className="mb-6 text-xl font-bold">Empresa</h3>
          ...
          <div>
            <h3 className="mb-6 text-xl font-bold">Contato</h3>
          ...
          <div>
            <h3 className="mb-6 text-xl font-bold">Redes Sociais</h3>
            ...
            <div className="flex gap-5">
              ...
              <LinkedinIcon className="h-7 w-7 cursor-pointer text-gray-400 transition hover:text-green-500" />
            </div>
          </div>
        </div>
