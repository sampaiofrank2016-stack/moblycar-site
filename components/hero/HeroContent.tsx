export default function HeroContent() {
  return (
    <div>
      ...
      <h1 className="text-5xl font-extrabold leading-[1.05] text-white lg:text-7xl">
        Sua cidade.
        <br />
      ...
      <div className="mt-10 flex gap-4">
        <button className="rounded-full bg-green-600 px-8 py-4 font-semibold text-white shadow-xl transition hover:scale-105 hover:bg-green-500">
          Baixar Aplicativo
        </button>
