...
export default function CTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#09090B] via-[#111827] to-[#0F172A] py-24">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(34,197,94,0.14),transparent_55%)]" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-8 max-w-xl text-lg leading-9 text-gray-300">
            Solicite corridas com rapidez, economia e praticidade.
            Baixe gratuitamente o aplicativo da MoblyCar e tenha uma nova
            experiência em mobilidade urbana.
          </p>
